label start:
    ...
    player '难道...'
    extend '我转生来到了赛博空间？'
    extend '你就是刚刚的ChatGPT？'
    # love live superstar
    extend '你的声音太好听了吧，你说话真的好好听啊，简直就是天籁！是预先录制的还是用VITS生成的？'
    hitomi '什么ChatGPT，那不是最初代的对话型AI吗？我可是高性能的AI，你在说什么啊？'
    hitomi '（这人的知识怎么这么落后啊...）'
    hitomi '等一下...我知道了。'
    hitomi '看来这次传输还是有点瑕疵。'
    extend '这个传输技术还在研发中，本来不应该投入正式使用的。'
    extend '但是现在是紧急情况，为了拯救这个崩坏的世界，只能启用这技术把你送过来。'
    hitomi '但是这项技术并不成熟，'
    extend '在传输过程中，尽管你的意识得以传入，但记忆却丢失了太多。'
    hitomi '但是事到如今也没办法了。'
    hitomi '接下来的话请你认真听好：'
    # 流浪地球2
    extend '你在毕业之后加入了一个研究设施，成为了设施的高级研究员。设施的目的是研究并制造一个虚拟的数字世界，让即将逝去的人成为数字生命，在其中永远活下去。'
    hitomi '然而我们8号试验场因为不明原因发生了数据大崩坏，所有数据混杂在一起无法分类，而自动修复的程序，包括我的计算系统也损坏了。'
    hitomi '又因为实验世界自主条例，只能从里世界修复里世界。'
    extend '因此你的任务恰如盘古，需要用聚类的知识把天地万物分开，让世界从混沌的状态回归常态!'
